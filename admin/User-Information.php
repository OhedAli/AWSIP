<?php $pagetitle = "User Information"; include_once "includes/autoload.php"; ?>
  <div class="wrapper">
                                ...
                                ?>
                                  <tr>
                                    <td><input type="checkbox" name="stdarr[]" class = "std_chk_box" value = "<?php echo $row['id'];?>" id = "std_<?php echo $row['id'];?>" onclick="CheckUncheckInd(this.class);">&nbsp;&nbsp;
                                      <a class="btn btn-outline-success btn-sm" href="gotouser?uid=<?php echo $row['id'];?>" target="_blank" >Login</a></td>
                                    <td><?php echo $sl; ?></td>
