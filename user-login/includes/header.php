    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          ?>
          <a href="Suport-People.php" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
          ...
          ?>
          <a href="Contact-People.php" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo ASSETS;?>/dist/img/profile.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
