<?php $pagetitle = "Dashboard | Home | User Panel"; include_once "includes/autoload.php"; ?>
  <?php 
    //$contact = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM contact "));  
    //$user = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM user "));  
    // $support = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM user "));  
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                             ...
                             <tbody>
                                <?php
                                  $getid = $_SESSION['user_admin_info']['id'];
                                  $sql = "SELECT  * FROM user WHERE id = $getid AND status = 1 ORDER BY id DESC";
